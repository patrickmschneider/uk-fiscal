...
Deficit charts: bold net-total overlays, components/net-only selector, history since 2000 (1990 option), and labelled forecast background shading. Pre-2024 history currently supplies ONS borrowing totals only; comparable OBR component history remains to be imported. OBR databank downloads returned HTTP 403 during this update.
