...
Deficit charts: bold net-total overlays, components/net-only selector, history since 2000 (1990 option), and labelled forecast background shading. Primary and net-interest history now extends to 1990–91, calculated from ONS using OBR Working Paper 17 table A.1 (JW2P−JW2L+JW2M). Historical structural/cyclical estimates remain to be imported. OBR databank downloads returned HTTP 403 during this update.
